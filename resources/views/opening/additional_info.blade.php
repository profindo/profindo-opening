...
<div class="d-flex flex-column container-fluid">
    <div id="cust_media" class="col d-flex flex-column form-group">
        ...
        <div class="col d-flex flex-lg-row flex-column">
            <div class="col form-group">
                <div class="preview-container mx-5 mb-2">
                    <img id="cust_media_ktp_preview" class="col img-fluid me-1" src="{!! $investor->media_ktp && Storage::disk('uploads')->exists($investor->media_ktp) ? $investor->ktpAsImage() : 'https://via.placeholder.com/420x250?text=e-KTP' !!}">
                </div>
            ...
            <div class="col form-group">
                <div class="preview-container mx-5 mb-2">
                    <img id="cust_media_npwp_preview" class="col img-fluid me-1" src="{!! $investor->media_ktp && Storage::disk('uploads')->exists($investor->media_npwp) ?  $investor->npwpAsImage() : 'https://via.placeholder.com/420x250?text=NPWP' !!}">
                </div>
        ...
        <div class="col d-flex flex-lg-row flex-column">
            <div class="col form-group">
                <div class="preview-container mx-5 mb-2">
                    <img id="cust_media_signature_preview" class="col img-fluid me-1" src="{!! $investor->media_ktp && Storage::disk('uploads')->exists($investor->media_signature) ?  $investor->signatureAsImage() : 'https://via.placeholder.com/420x250?text=Tanda+Tangan' !!}">
                </div>
            ...
            <div class="col form-group">
                <div class="preview-container mx-5 mb-2">
                    <img id="cust_media_selfie_preview" class="col img-fluid me-1" src="{!! $investor->media_ktp && Storage::disk('uploads')->exists($investor->media_selfie) ?  $investor->selfieAsImage() : 'https://via.placeholder.com/420x250?text=Selfie+memegang+KTP' !!}">
                </div>
