<div class="container-fluid d-flex flex-column text-dark">
    <div class="col d-flex flex-row mb-5">
        <div class="col">
            <img class="img img-fluid" src="{{ asset('img/logo.png') }}" alt="Logo">
        </div>
        <div class="col-lg-11 col-sm-10 d-flex flex-column m-1 justify-content-center">
    ...
    <div class="text-start">
        <h6>Perjanjian Pembukaan Rekening Efek ("Perjanjian") ini dibuat dan ditandatangani di pada tanggal [dd/mm/yy],
            oleh dan antara: </h6>
    </div>
    <ol>
        <li>
    ...
    <div class="text-center mt-2">
        ...
        <strong>PEMBUKAAN REKENING</strong>
    </div>
    <ol class="ol-custom">
        <li class="li-custom text-custom text-justify text-start">
    ...
    <div class="text-center mt-2">
        ...
        <strong>SYARAT - SYARAT PEMBUKAAN REKENING</strong>
    </div>
    <ol class="ol-custom">
        <li class="li-custom text-custom text-justify text-start">
    ...
    <div class="text-center mt-2">
        ...
        <strong>PENGOPERASIAN REKENING</strong>
    </div>
    <p>
    ...
    <div class="text-center mt-2">
        ...
        <strong>PENUTUPAN REKENING</strong>
    </div>
    <p>
        ...
        <li class="li-custom text-custom text-justify text-start">
            ...
            <ol type="a">
                ...
                <li class="sub-rekening text-custom-2 text-justify text-start">
                    ...
                    <ol type="i">
                        <li class="syarat-pengumpulan text-custom-2 text-justify text-start">
    ...
    <div class="text-center mt-2">
        ...
        <strong>KETENTUAN - KETENTUAN LAIN</strong>
    </div>
    <ol class="ol-custom">
        <li class="li-custom text-custom text-justify text-start">
    ...
    <ol>
        <strong class="paraghraph-letter-3 text-start text-justify">
